$(document).ready(function () {
                ...
                action: function (e, dt, node, config) {
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (deletedCategories.ResultStates===0) {
    ...
    $(document).on('click',
        ...
        function (event) {
            ...
            let categoryName = tableRow.find('td:eq(0)').text();
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (undoDeletedCategoryResult.ResultStates === 0) {
                                Swal.fire(
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (hardDeleteResult.ResultStates === 0) {
                                Swal.fire(
