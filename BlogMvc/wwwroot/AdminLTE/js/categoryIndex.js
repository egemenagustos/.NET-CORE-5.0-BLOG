$(document).ready(function () {
                ...
                action: function (e, dt, node, config) {
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (categoryListDto.ResultStates === 0) {
    ...
    $(document).on('click', '.btn-delete', function (event) {
        ...
        const categoryName = tableRow.find('td:eq(0)').text();
        Swal.fire({
